    ...
    <div className="auth-page">
      <Card className="auth-card">
        ...
        <div className="auth-header">
          ...
          <h1 className="auth-title">Secure Team Voting Platform</h1>
          <p className="auth-subtitle">Sign in to cast your vote</p>
        </div>

        {/* INFO BADGE */}
        <div className="auth-badge">
          <span>Each user is allowed to vote only once.</span>
        </div>
        ...
        <p className="auth-helper">
          Authentication is required to ensure fair and secure voting.
        </p>
      </Card>
    </div>
  );
